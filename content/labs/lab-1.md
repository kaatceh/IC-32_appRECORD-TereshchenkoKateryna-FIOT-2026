...
**Мета:** сформулювати ключові складові опису інформаційної системи та створити адаптивний web-застосунок з використанням HTML, CSS і JavaScript.
...
![Головна](https://kaatceh.github.io/IC-32_appRECORD-TereshchenkoKateryna-FIOT-2026/assets/labs/lab-1/screen-1.png)
![Мобільна](https://kaatceh.github.io/IC-32_appRECORD-TereshchenkoKateryna-FIOT-2026/assets/labs/lab-1/screen-2.png)

---
## Use-case діаграма

![Use-case](https://kaatceh.github.io/IC-32_appRECORD-TereshchenkoKateryna-FIOT-2026/assets/labs/lab-1/usecase.png)
...
![ER](https://kaatceh.github.io/IC-32_appRECORD-TereshchenkoKateryna-FIOT-2026/assets/labs/lab-1/er.png)
...
---
## Реалізація REST API на Node.js та Express.js

![Backend](https://kaatceh.github.io/IC-32_appRECORD-TereshchenkoKateryna-FIOT-2026/assets/labs/lab-1/backend.png)

Для реалізації серверної частини було використано Node.js та Express.js. 
Було створено REST API для роботи зі студентами з підтримкою HTTP-методів GET, POST, PUT та DELETE.
